...
/*
	...
	cases. 	LNX, T64, and ARK serve this purpose, but each has its own quirks or limitations.  
...
//			entry.readBytes( fileNameBytes, 0, 16 );
			...
			var fileEntry:Array = readFileData( ft, fs, filesizeInSectors, lsu, trackList );
			...
			if ( errorBytesPresent )
			{
				...
				var errorByteArray:Array  = readFileData( errTrack, errSector, numBlocks, 0, trackList );
		...
		private function readFileData( track:int, sector:int, lengthInSectors:int, lsu:int, trackList:Array ):Array
		{
