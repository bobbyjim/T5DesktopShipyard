...
*/
{
	...
	public class D82b extends CMD implements Storable
	{
		public function D82b( fn:String=null )
		{
			super(fn);
			...
			var zones:Array 			= [ [39,29], [14,27], [11,25], [13,23] ];
			var doubleSided:Boolean 	= true;
			var errorBytes:Boolean 		= false;
			var headerTrack:int 		= 39;
			var dirSector:int 			= 3;
			var hdrDiskNameOffset:int 	= 0x06;
			var bamOffset:int 			= 0x06;
			var bamXlv:int 				= 3;
			var prependBamXlv:Boolean	= false;
			var fileXlv:int				= 1;
			var dirXlv:int				= 1;
			var bamPointToDir:Boolean	= false;
			var bamHasCount:Boolean		= true;

			BAM_TRACK                   = 38;  // don't we still need this?
