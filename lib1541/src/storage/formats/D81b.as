...
*/
{
	...
	public class D81b extends CMD implements Storable
	{
		public function D81b( fn:String=null)
		{
			super(fn);
			...
			var zones:Array 			= [ [80,40] ]; 
			var doubleSided:Boolean 	= false;
			var errorBytes:Boolean 		= false;
			var headerTrack:int 		= 40;
			var dirSector:int 			= 3;
			var hdrDiskNameOffset:int 	= 0x04;
			var bamOffset:int 			= 0x10;
			var bamXlv:int 				= 1;
			var prependBamXlv:Boolean	= true;
			var fileXlv:int				= 1;
			var dirXlv:int				= 1;
