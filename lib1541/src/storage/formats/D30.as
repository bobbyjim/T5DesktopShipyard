...
package storage.formats
	 ...
	 * 
	 * Its configuration has a BAM which can address 300k of storage:
	 * 1240 sectors, in 31 tracks of 40 sectors each, and a 6-byte BAM.
	 * 
	 ...
	 */
{
	...
	public class D30 extends CMD implements Storable
	{
		public function D30(fn:String=null)
		{
				super(fn);

				var zones:Array 			= [ [31,40] ];
