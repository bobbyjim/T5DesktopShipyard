...
package storage
{
	...
	import storage.formats.D10;
	import storage.formats.D16;
	import storage.formats.D20;
	import storage.formats.D28;
	import storage.formats.D30;
...
//				case 'G64': return new G64();
				...
				// My homemade images.
				case 'D28': return new D28( imgName );   // 46 k
				case 'D10': return new D10( imgName );   // 100 k
				case 'D20': return new D20( imgName );   // 200 k
				case 'D30': return new D30( imgName );   // 300 k
				...
				// Ruud Baltissen's 16 megabyte image
